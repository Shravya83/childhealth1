...
$sql="delete from `doctordb` where `emailid`='$id'";
if(mysqli_query($conn, $sql))
{
     echo "<script type=\"text/javascript\">alert(\"Doctor Deleted Succesfully\");</script>";
                 echo "<META http-equiv=\"refresh\" content=\"0;viewdoctorshosp\">";
}
else
{
    echo "<script type=\"text/javascript\">alert(\"Doctor Deleting Failed\");</script>";
                 echo "<META http-equiv=\"refresh\" content=\"0;viewdoctorshosp\">"; 
}
}
